...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/24 18:02:37 by kcaraway          #+#    #+#             */
/*   Updated: 2020/11/25 06:33:46 by kcaraway         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	char s1[100];
	char *s2;
				printf("-----\033[33mtest strlen\033[0m-----\n");
    printf("\033[32mstrlen\033[0m=%ld\n", strlen(s));
    printf("\033[31mft_strlen\033[0m=%ld\n", ft_strlen(s));
    printf("\033[32mstrlen\033[0m=%ld\n", strlen(""));
    printf("\033[31mft_strlen\033[0m=%ld\n", ft_strlen(""));

				printf("-----\033[33mtest strcmp\033[0m-----\n");
    printf("\033[32mstrcmp\033[0m=%d\n", strcmp(s, ""));
    printf("\033[31mft_strcmp\033[0m=%d\n", ft_strcmp(s, ""));
    printf("\033[32mstrcmp\033[0m=%d\n", strcmp("", ""));
    printf("\033[31mft_strcmp\033[0m=%d\n", ft_strcmp("", ""));
    printf("\033[32mstrcmp\033[0m=%d\n", strcmp("", s));
    printf("\033[31mft_strcmp\033[0m=%d\n", ft_strcmp("", s));
    ...
    printf("\033[31mft_strcmp\033[0m=%d\n", ft_strcmp(s, s));
				...
				printf("-----\033[33mtest strcpy\033[0m-----\n");
    printf("\033[32mstrcpy\033[0m=%s\n", strcpy(s1, s));
    printf("\033[31mft_strcpy\033[0m=%s\n", ft_strcpy(s1, s));
    printf("\033[32mstrcpy\033[0m=%s\n", strcpy(s1, ""));
    printf("\033[31mft_strcpy\033[0m=%s\n", ft_strcpy(s1, ""));
    ...
    printf("\033[31mft_strcpy\033[0m=%s\n", ft_strcpy(s1, "0987654321"));
				...
				printf("-----\033[33mtest ft_write\033[0m-----\n");
	errno = 0;
	printf("\n\033[32mwrite\033[0m=%ld, \033[32merrno\033[0m=%d\n", write(0, s, strlen(s)), errno);
	errno = 0;
	...
	errno = 0;
	printf("\033[32mread\033[0m=%ld,\033[32ms1\033[0m=%s, \033[32merrno\033[0m=%d\n", read(fd, NULL, 100), s1, errno);
	close(fd);
	fd=open("file", O_RDONLY);
	errno = 0;
	printf("\033[31mft_read\033[0m=%ld,\033[31ms1\033[0m=%s, \033[31merrno\033[0m=%d\n", ft_read(fd, NULL, 100), s1, errno);
	close(fd);
	...
	fd=open("file", O_RDONLY);
	errno = 0;
	printf("\033[32mft_read\033[0m=%ld,\033[32ms1\033[0m=%s, \033[32merrno\033[0m=%d\n", read(fd, s1, 100), s1, errno);
	close(fd);
	fd=open("file", O_RDONLY);
	errno = 0;
	...
	close(fd);
				...
				printf("-----\033[33mtest ft_strdup\033[0m-----\n");
	s2 = strdup(s);
	printf("\033[32mstrdup\033[0m=%s, \033[32mlen\033[0m=%ld\n", s2, strlen(s2));
	free(s2);
	s2 = ft_strdup(s);
	printf("\033[31mft_strdup\033[0m=%s, \033[31mlen\033[0m=%ld\n", s2, strlen(s2));
	free(s2);
...
// 	s2 = strdup(str);
// 	printf("\033[32mstrdup\033[0m=%s\n\033[32mlen\033[0m=%ld\n", s2, strlen(s2));
// 	free(s2);
// 	s2 = ft_strdup(str);
// 	printf("\033[31mft_strdup\033[0m=%s\n\033[31mlen\033[0m=%ld\n", s2, strlen(s2));
// 	free(s2);
